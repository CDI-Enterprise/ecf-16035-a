...
public class Department {
	...
	public static final String[] DEPARTMENTS = { "Ain", "Aisne", "Allier", "Alpes de Hautes-Provence", "Hautes-Alpes", 
			...
			"Orne", "Pas-de-Calais", "Puy-de-Dôme", "Pyrénées-Atlantiques", "Hautes-Pyrénées", "Pyrénées-Orientales", "Bas-Rhin",
			"Haut-Rhin", "Rhône", "Haute-Saône", "Saône-et-Loire", "Sarthe", "Savoie", "Haute-Savoie", "Paris", "Seine-Maritim",
