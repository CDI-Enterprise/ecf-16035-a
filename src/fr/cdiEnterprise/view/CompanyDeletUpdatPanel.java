...
//		for (Livre livre: Datas.getListeLivresBiblio()){
//			dlmLivre.addElement(livre);
//		}
//		JScrollPane livres = new JScrollPane(lstLivres, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, 
//				JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
//		livres.setPreferredSize(new Dimension(300, 50));
